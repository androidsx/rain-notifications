...
public enum WeatherType {
     ...
     * source, after all.
     */
    UNKNOWN(0, R.string.clear_noun, R.string.clear_adjective, R.string.clear_gerund), // This values are never used for UNKNOWN Weather
    CLEAR(1, R.string.clear_noun, R.string.clear_adjective, R.string.clear_gerund),
    CLOUDY(2, R.string.cloudy_noun, R.string.cloudy_adjective, R.string.cloudy_gerund),
    RAIN(3, R.string.rain_noun, R.string.rain_adjective, R.string.rain_gerund),
    SNOW(4, R.string.snow_noun, R.string.snow_adjective, R.string.snow_gerund);

    /**
     * Higher values ​​indicate greater relevance
     */
    private int relevance;
    private int nounResId;
    private int adjectiveResId;
    private int gerundResId;

    private WeatherType(int relevance, int nounResId, int adjectiveResId, int gerundResId) {
        this.relevance = relevance;
        this.nounResId = nounResId;
    ...
    public String getNoun(Context context) {
        return context.getString(nounResId);
    }
